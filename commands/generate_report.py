...
def main():
    ...
    output_lines.append("\n# acrossservice")
    output_lines.append("| Project_Language | CloneSetCount | Clone Ratio (Testing) | Clone Ratio (Production) | Clone Ratio (Utility) | Comodification Rate (Testing) | Comodification Rate (Production) | Comodification Rate (Utility) |")
    output_lines.append("|--------------------|----------------|-----------------------|-------------------------|----------------------|-------------------------------|---------------------------------|-------------------------------|")
    for key, value in results.items():
