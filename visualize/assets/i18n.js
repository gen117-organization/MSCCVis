...
const VIS_I18N = {
  en: {
    ...
    // Filters
    filterDetection: "Detection Method:",
    filterComod: "Co-modification:",
    filterScope: "Scope:",
    filterCodeType: "Code Type:",
    filterCloneId: "Clone ID search:",
    filterManyServices: "Many Services:",
    cloneIdPlaceholder: "Input Clone ID",
    manyServicesPlaceholder: "Select Clone ID (Many Services)",
    // Scatter details
  ...
  ja: {
    ...
    filterDetection: "検出手法:",
    filterComod: "同時修正:",
    filterScope: "スコープ:",
    filterCodeType: "コードタイプ:",
    filterCloneId: "クローンID検索:",
    filterManyServices: "複数サービス:",
